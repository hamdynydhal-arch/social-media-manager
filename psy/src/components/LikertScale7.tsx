const OPTIONS = [
  ...
  },
  {
    ...
    base:   'bg-pink-50 border-pink-100 hover:bg-pink-100 hover:border-pink-300',
    active: 'bg-pink-100 border-pink-400 shadow-md shadow-pink-100',
    numBase: 'text-pink-300',   numActive: 'text-pink-700',
    lblActive: 'text-pink-700',
  },
  {
    value: 4, short: '4', label: 'محايد',
