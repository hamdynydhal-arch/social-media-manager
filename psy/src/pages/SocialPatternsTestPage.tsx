...
import { AXIS_LABELS } from '../data/socialPatternsContent';

const STORAGE_KEY = 'nafees_social_patterns_progress';

interface SocialPatternsTestPageProps {
...
export default function SocialPatternsTestPage({
  questions,
  onComplete,
  onReset,
  onHome,
}: SocialPatternsTestPageProps) {
  ...
  return (
    <div className="min-h-screen bg-nafees-cream flex flex-col" dir="rtl">
      ...
      <div className="h-1.5 bg-nafees-cream-dark">
        <div
          className="h-full bg-nafees-navy transition-all duration-500"
      ...
      <div className="flex-1 flex flex-col justify-center px-4 py-8 max-w-lg mx-auto w-full">
        ...
        <div className="mb-4">
          <span
            ...
            style={{ background: 'rgba(15,45,69,0.08)', color: '#0F2D45' }}
          >
