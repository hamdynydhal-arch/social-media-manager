...
export default function IntakePage({ onHome, onComplete, onSelectSettings }: IntakePageProps) {
      ...
      <div className="bg-nafees-navy px-4 pt-10 pb-8 rounded-b-[2.5rem]">
        <div className="max-w-md mx-auto">
          <div className="flex items-center justify-between mb-4">
            <button
              onClick={onHome}
              className="text-nafees-cream-dark/60 text-sm flex items-center gap-1 active:scale-95 transition-transform duration-150"
            >
              ← رجوع
            </button>
            {onSelectSettings && (
