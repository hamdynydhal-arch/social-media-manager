...
export default function ForceInstallModal() {
      ...
      >
        ...
        <div className="px-5 pb-6 space-y-3">
          {isIOS ? (
            ...
            <>
              <p className="text-center text-slate-300 text-sm font-bold">
              ...
              {[
                ...
                },
                {
                  n: '3',
                  icon: '✅',
                  label: 'اضغط "إضافة" في الزاوية العلوية',
                  sub: '',
                },
              ...
              {notifPerm === 'granted' && (
                <div className="bg-emerald-900/40 border border-emerald-500/30 rounded-2xl p-2.5 text-center">
                  <p className="text-emerald-400 text-xs font-bold">✅ الإشعارات مفعّلة — ثبّت التطبيق للاستمتاع الكامل</p>
                </div>
              )}

              <button onClick={dismiss} className="w-full py-2 text-slate-500 text-xs font-medium">
                ليس الآن
              </button>
            </>
          ) : (
            ...
            <>
              ...
              {!installPrompt && !isIOS && needsNotif && (
                <button
